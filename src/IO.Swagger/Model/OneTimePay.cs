...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OneTimePay :  IEquatable<OneTimePay>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OneTimePay);
        }

        /// <summary>
        /// Returns true if OneTimePay instances are equal
        /// </summary>
        /// <param name="other">Instance of OneTimePay to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneTimePay other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
